...
let tokenUris = [
    'ipfs://QmdbxQgojsJm9FDhjwkggWSPZ4faMDdqpd1qRomKkSeYpC',
    'ipfs://Qmek3hUWAfFe5HDdnbNr1SZHkhUWyWuZwAyWehFw4EFAaM',
...
async function handleTokenUris() {
    ...
    for (imageUploadResponseIndex in imageUploadResponses) {
        ...
        tokenUriMetadata.description = `Magical ${tokenUriMetadata.name} orb!`
